...
from my_utils.misc import NativeScalerWithGradNormCount as NativeScaler
...
def get_args_parser():
    ...
    #
    parser.add_argument('--pretrain_path', default='/home/lab301-3090/wujun/SparseViT-main/checkpoint/train/pretrain/uniformer_base_ls_in1k.pth', type=str, help='path to uniformer pretrain model')
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/home/lab301-3090/wujun/SparseViT-main/balanced_dataset.json', type=str,
                        help='dataset path, should be our json_dataset or mani_dataset format. Details are in readme.md')
    parser.add_argument('--test_data_path', default='/home/lab301-3090/wujun/SparseViT-main/data___json/casia1.0.json', type=str,
...
def main(args):
    ...
    train_transform = my_utils.sparsevit_transforms.get_albu_transforms('train')
    test_transform = my_utils.sparsevit_transforms.get_albu_transforms('test')

    # ---- dataset with crop augmentation ----
    dataset_train = my_utils.datasets.balanced_dataset(
        path=args.data_path,
        sample_number=1840,
    ...
    if os.path.isdir(args.test_data_path):
        dataset_test = my_utils.datasets.mani_dataset(args.test_data_path, transform=test_transform)
    else:
        dataset_test = my_utils.datasets.json_dataset(args.test_data_path, transform=test_transform)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # saving checkpoint
        if args.output_dir and (epoch % 1 == 0 and epoch != 0 or epoch + 1 == args.epochs):
            misc.save_model(
